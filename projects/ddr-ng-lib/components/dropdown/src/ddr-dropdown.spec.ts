...
describe('DdrDropdown', () => {
  ...
  let fixtureDropdownObject: ComponentFixture<
  ...
  beforeEach(async () => {
    ...
    fixtureDropdownNumber = TestBed.createComponent(
      DdrDropdownComponent<number>,
    );
    ...
    inputGroupDropdownNumber = fixtureDropdownNumber.debugElement.query(
      By.directive(DdrInputGroupComponent),
    );

    fixtureDropdownObject = TestBed.createComponent(
      DdrDropdownComponent<{
        value: string;
      }>,
    );
    ...
    fixtureDropdownObject.componentRef.setInput(
      'compareFn',
      (
        a: {
          value: string;
    ...
    inputGroupDropdownObject = fixtureDropdownObject.debugElement.query(
      By.directive(DdrInputGroupComponent),
    );
  });
  ...
  it('element should be selected (numbers)', async () => {
    ...
    let panelItems = fixtureDropdownNumber.debugElement.query(
    ...
    fixtureDropdownNumber.detectChanges();
    const firstElement = fixtureDropdownNumber.debugElement.query(
      By.css('.ddr-dropdown__panel-items ul li:first-child'),
    );
    ...
    expect(
      componentDropdownNumber.selectItem.emit,
      'El evento selectItem debe lanzarse',
  ...
  it('element should be selected (objects)', async () => {
    ...
    let panelItems = fixtureDropdownObject.debugElement.query(
      By.css('.ddr-dropdown__panel-items'),
    );
    expect(panelItems).not.toBeNull();
    ...
    fixtureDropdownObject.detectChanges();
    const firstElement = fixtureDropdownObject.debugElement.query(
      By.css('.ddr-dropdown__panel-items ul li:first-child'),
    );
    firstElement.triggerEventHandler('click');
    fixtureDropdownObject.detectChanges();
    ...
    expect(
      componentDropdownObject.selectItem.emit,
      'El evento selectItem debe lanzarse',
    ).toHaveBeenCalledWith({
      label: 'Label1',
      value: { value: 'Value1' },
  ...
  it('should filter by text', async () => {
    ...
    let inputFilter = fixtureDropdownObject.debugElement.query(
      By.css('.ddr-dropdown__panel-items--search--input'),
    );
    inputFilter.nativeElement.value = 'Label2';
    inputFilter.nativeElement.dispatchEvent(new Event('input'));
    fixtureDropdownObject.detectChanges();

    let firstElement = fixtureDropdownObject.debugElement.query(
      By.css('.ddr-dropdown__panel-items ul li:first-child'),
    );
