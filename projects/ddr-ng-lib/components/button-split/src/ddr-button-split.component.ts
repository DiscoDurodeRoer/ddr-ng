...
import { DdrOrientationButtonSplit, DdrSize } from 'ddr-ng/types';
...
@Component({
  ...
  styleUrl: './ddr-button-split.component.scss',
  encapsulation: ViewEncapsulation.None,
  imports: [DdrButtonComponent, DdrTranslatePipe, DdrClickOutsideDirective],
  animations: [
