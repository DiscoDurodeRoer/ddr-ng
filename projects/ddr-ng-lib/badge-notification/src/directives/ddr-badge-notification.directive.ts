...
export class DdrBadgeNotificationDirective {
  ...
  readonly showNotifications: InputSignal<boolean> = input<boolean>(true);
  readonly numberNotifications: InputSignal<number> = input<number>(0);
  readonly limitNotifications: InputSignal<number> = input<number>(9);
  readonly elementToInsert: InputSignal<string> = input<string>('');
  readonly positionTop: InputSignal<string> = input<string>('');
  readonly positionRight: InputSignal<string> = input<string>('');
