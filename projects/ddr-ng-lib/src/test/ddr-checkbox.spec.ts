...
describe('DdrCheckboxComponent', () => {
    ...
    it('should click checks', () => {
        ...
        fixture.detectChanges();
        expect(component.clickCheck.emit, 'El evento clickCheck debe lanzarse').toHaveBeenCalledWith(['java']);
        ...
        fixture.detectChanges();
        expect(component.clickCheck.emit, 'El evento clickCheck debe lanzarse').toHaveBeenCalledWith(['java', 'angular']);

        firstCheckbox.triggerEventHandler('click');

        fixture.detectChanges();
        expect(component.clickCheck.emit, 'El evento clickCheck debe lanzarse').toHaveBeenCalledWith(['angular']);
    ...
    it('should not click checkbox', () => {
        ...
        for (const checkbox of checkboxes) {
            ...
            fixture.detectChanges();
            expect(component.clickCheck.emit, 'El evento clickCheck no debe lanzarse').not.toHaveBeenCalledWith();
        }
